import pygame
import obstacles_working as obstacles1
...
class Main:
    def __init__(self):
        ...
        self.levelattrs = [[2, obstacles1.level1obstacles, 1], [2, obstacles1.level2obstacles, 1],
                           [2, obstacles1.level3obstacles, 1], [2, obstacles1.level4obstacles, 1],
                           [2, obstacles1.level5obstacles, 1], [2, obstacles1.level6obstacles, 1],
                           [2, obstacles1.level7obstacles, 1], [2, obstacles1.level8obstacles, 1],
                           [2, obstacles1.level9obstacles, 1]]
...
# ---------------------------------- Level Creation Function ---------------------------------------
    ...
    def level(self, player_velocity, obstacle_func, obstacle_velocity):
        ...
        while self.main and self.run_level:
            ...
            rectlist2 = obstacles1.finish_line(self.obstacle_x_change, self.window)
