...
def level3obstacles(obstacle_x_change, window):
    rect1 = pygame.draw.rect(window, (255, 0, 0), (0 - obstacle_x_change, 0, 200, 150))
    rect2 = pygame.draw.rect(window, (255, 0, 0), (0 - obstacle_x_change, 450, 200, 150))
    rect3 = pygame.draw.rect(window, (255, 0, 0), (200 - obstacle_x_change, 0, 150, 300))
    rect4 = pygame.draw.rect(window, (255, 0, 0), (350 - obstacle_x_change, 0, 200, 150))
...
def level4obstacles(obstacle_x_change, window):
    rect1 = pygame.draw.rect(window, (255, 0, 0), (0 - obstacle_x_change, 0, 200, 150))
    rect2 = pygame.draw.rect(window, (255, 0, 0), (0 - obstacle_x_change, 450, 200, 150))
    rect3 = pygame.draw.rect(window, (255, 0, 0), (200 - obstacle_x_change, 0, 150, 300))
    rect4 = pygame.draw.rect(window, (255, 0, 0), (350 - obstacle_x_change, 0, 200, 150))
...
def level5obstacles(obstacle_x_change, window):
    rect1 = pygame.draw.rect(window, (255, 0, 0), (0 - obstacle_x_change, 0, 200, 150))
    rect2 = pygame.draw.rect(window, (255, 0, 0), (0 - obstacle_x_change, 450, 200, 150))
    rect3 = pygame.draw.rect(window, (255, 0, 0), (200 - obstacle_x_change, 0, 150, 300))
    rect4 = pygame.draw.rect(window, (255, 0, 0), (350 - obstacle_x_change, 0, 200, 150))
...
def level6obstacles(obstacle_x_change, window):
    rect1 = pygame.draw.rect(window, (255, 0, 0), (0 - obstacle_x_change, 0, 200, 150))
    rect2 = pygame.draw.rect(window, (255, 0, 0), (0 - obstacle_x_change, 450, 200, 150))
    rect3 = pygame.draw.rect(window, (255, 0, 0), (200 - obstacle_x_change, 0, 150, 300))
    rect4 = pygame.draw.rect(window, (255, 0, 0), (350 - obstacle_x_change, 0, 200, 150))
...
def level7obstacles(obstacle_x_change, window):
    rect1 = pygame.draw.rect(window, (255, 0, 0), (0 - obstacle_x_change, 0, 200, 150))
    rect2 = pygame.draw.rect(window, (255, 0, 0), (0 - obstacle_x_change, 450, 200, 150))
    rect3 = pygame.draw.rect(window, (255, 0, 0), (200 - obstacle_x_change, 0, 150, 300))
    rect4 = pygame.draw.rect(window, (255, 0, 0), (350 - obstacle_x_change, 0, 200, 150))
...
def level8obstacles(obstacle_x_change, window):
    rect1 = pygame.draw.rect(window, (255, 0, 0), (0 - obstacle_x_change, 0, 200, 150))
    rect2 = pygame.draw.rect(window, (255, 0, 0), (0 - obstacle_x_change, 450, 200, 150))
    rect3 = pygame.draw.rect(window, (255, 0, 0), (200 - obstacle_x_change, 0, 150, 300))
    rect4 = pygame.draw.rect(window, (255, 0, 0), (350 - obstacle_x_change, 0, 200, 150))
...
def level9obstacles(obstacle_x_change, window):
    rect1 = pygame.draw.rect(window, (255, 0, 0), (0 - obstacle_x_change, 0, 200, 150))
    rect2 = pygame.draw.rect(window, (255, 0, 0), (0 - obstacle_x_change, 450, 200, 150))
    rect3 = pygame.draw.rect(window, (255, 0, 0), (200 - obstacle_x_change, 0, 150, 300))
    rect4 = pygame.draw.rect(window, (255, 0, 0), (350 - obstacle_x_change, 0, 200, 150))
